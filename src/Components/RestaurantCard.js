...
class RestaurantCard extends React.Component{
    ...
    render(){
        ...
        return(
            <div>
            <Card className="ml-4 mr-4 mb-5 resCard"style={{width: '18rem', height:"25rem"}}>
            ...
            <Card.Text>
            {this.props.restaurantObj.categories.length === 0 ? null : <Card.Text className="categorylist">{this.props.restaurantObj.categories.map(cuisine => <li key={cuisine}>{cuisine}</li>)}</Card.Text> }
            </Card.Text>
            </Card.Body>
            <Card.Body>
